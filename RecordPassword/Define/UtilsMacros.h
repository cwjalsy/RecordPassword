...
#define FOURSSCREEN ([UIScreen mainScreen].bounds.size.height == 480)

#define FIVESCREEN ([UIScreen mainScreen].bounds.size.height == 568)

#define SIXSCREEN ([UIScreen mainScreen].bounds.size.height == 667)

#define SIXPLUSSCREEN  ([UIScreen mainScreen].bounds.size.height == 1104)
...
//字体适配，高度适配
#define kARHeightTranslator(padding) (padding * KScreenHeight / 667.0)
